...
class Auth with ChangeNotifier {
  ...
  Future<void> logout() async {
    ...
    // prefs.clear(); This will also clear every other datain shared prefs, which the app might need. So just delete the relevant data.
  }
  ...
  void _autoLogout() {
    ...
    // print('Time to expiry: $timeToExpiry'); 3600 seconds
